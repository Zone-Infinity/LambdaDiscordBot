...
public class RPSCommand implements ICommand {
    ...
    public void handle(CommandContext ctx) {
        ...
        if(args.get(0).toLowerCase().startsWith("r")){result.append(s.startsWith("p")?"I win !! :D":"You win !! D:");}
        if(args.get(0).toLowerCase().startsWith("p")){result.append(s.startsWith("s")?"I win !! :D":"You win !! D:");}
        if(args.get(0).toLowerCase().startsWith("s")){result.append(s.startsWith("r")?"I win !! :D":"You win !! D:");}
