...
public class BlurCommand implements ICommand {
    ...
    public void handle(CommandContext ctx) {
        ...
        if (Utils.isNotUrl(args.get(0))) {
            ...
            try {
                blurImage(channel, effectiveAvatarUrl);
            } catch (IOException e) {
                e.printStackTrace();
            }
            return;
        ...
        try {
            blurImage(channel, args.get(0));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }

    public static void blurImage(TextChannel channel, String url) throws IOException {
        ...
        Request request = new Request.Builder()
                .url("https://apis.duncte123.me/filters/blur")
                .post(req)
                .build();
        ...
        try (Response res = call.execute()) {
            ...
            channel.sendMessage("Here's you blurred image")
